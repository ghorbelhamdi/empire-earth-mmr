...
const allowed = new Set(['state:get', 'settings:save', 'players:load', 'watch:start', 'watch:stop', 'capture:game', 'capture:import', 'draft:save', 'draft:new', 'match:preview', 'match:submit', 'captures:open']);
